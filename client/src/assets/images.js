import Customer1 from './images/customer-1.avif'
...
export const clients = [
    { name: 'Ball', logo: client1 },
    { name: 'Cooper Tires', logo: client2 },
    { name: 'Diligent', logo: client3 },
    { name: 'Hayagreeva', logo: client4 },
    { name: 'Loreal', logo: client5 },
    { name: 'OTM Labs', logo: client6 },
